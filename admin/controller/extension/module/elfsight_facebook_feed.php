...
class ControllerExtensionModuleElfsightFacebookFeed extends Controller {
    ...
    const ELFSIGHT_EMBED_URL = 'https://apps.elfsight.com/embed/facebook-feed/?utm_source=portals&utm_medium=opencart&utm_campaign=facebook-feed&utm_content=sign-up';
    ...
    public function index() {
        ...
        $data['action'] = $this->url->link('extension/module/elfsight_facebook_feed', 'user_token=' . $this->session->data['user_token'], true);

        $data['cancel'] = $this->url->link('marketplace/extension', 'user_token=' . $this->session->data['user_token'] . '&type=module', true);

        if (isset($this->request->post['module_facebook_feed_status'])) {
            $data['module_facebook_feed_status'] = $this->request->post['module_facebook_feed_status'];
        } else {
            $data['module_facebook_feed_status'] = $this->config->get('module_facebook_feed_status');
        }
